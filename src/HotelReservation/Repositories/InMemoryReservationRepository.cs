...
public class InMemoryReservationRepository
    : IReservationDataAccess,
      IReservationBillingMetrics,
      IReservationOccupancyMetrics,
      IReservationOverlapQuery
{
    private readonly Dictionary<string, Reservation> _reservations = new();
    private readonly BillingCalculator _billingCalculator;

    public InMemoryReservationRepository(BillingCalculator billingCalculator)
    {
    ...
    public decimal GetTotalRevenue(DateTime from, DateTime to)
    {
        return _reservations.Values
            ...
            .Sum(r => _billingCalculator.CalculateTotal(r));
    }
